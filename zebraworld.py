    ...
    def __init__(self, **kwargs):
        ...
        self.prog = self.ctx.program(
            vertex_shader='''
                ...
                void main() {
                    vec4 vertex = vec4(in_vert - 0.5, texture(Heightmap, in_vert).r * 0.2, 1.0); //Vertex shader based on the Heightmap.jpg. To be replaced with our own noise function and tesselated values
